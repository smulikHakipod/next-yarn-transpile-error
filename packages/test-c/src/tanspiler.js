 ...
 */
 ...
 const createWebpackMatcher = (modulesToTranspile, logger = createLogger(false)) => {
  console.log('modulesToTranspile', modulesToTranspile);
   ...
   console.log("modulePathsWithDepth", modulePathsWithDepth);
   ...
   return (filePath) => {
    console.log('filePath', filePath);
     ...
     return modulePathsWithDepth.some(([modulePath, moduleDepth]) => {
       ...
       console.log("filePath", filePath, "modulePath", modulePath, "transpiled", transpiled);
